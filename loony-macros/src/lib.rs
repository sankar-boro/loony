...
//! - `guard = "function_name"` - Registers function as guard using `loony::web::guard::fn_guard`
...
//!
//! ```rust
//! use loony::web::{get, Error, HttpResponse};
...
/// Marks async function to be executed by loony system.
///
/// ## Usage
///
/// ```rust
...
pub fn rt_main(_: TokenStream, item: TokenStream) -> TokenStream {
    ...
    (quote! {
        #(#attrs)*
        #vis #sig {
            loony::rt::System::new(stringify!(#name))
...
/// Marks async test function to be executed by loony runtime.
///
/// ## Usage
///
/// ```no_run
