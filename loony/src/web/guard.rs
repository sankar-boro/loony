//! Route match guards.
//!
//! Guards are one of the ways how loony web router chooses a
...
//! and *routes*. loony provide several guards by default, like various
...
//!
//! ```rust
//! use loony::http::Method;
//! use loony::web::{self, guard, App, HttpResponse};
//!
//! fn main() {
...
///
/// ```rust
/// use loony::web::{self, guard::Host, App, HttpResponse};
///
/// fn main() {
///     App::new().service(
