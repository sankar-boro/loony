...
/// use loony::web::{self, error, App, HttpResponse};
///
/// /// extract binary data from request
/// async fn index(mut body: web::types::Payload) -> Result<HttpResponse, error::PayloadError>
/// {
///     let mut bytes = BytesMut::new();
///     while let Some(item) = loony::util::next(&mut body).await {
...
/// use futures::{Future, Stream};
/// use loony::util::BytesMut;
/// use loony::web::{self, error, App, Error, HttpResponse};
///
/// /// extract binary data from request
/// async fn index(mut body: web::types::Payload) -> Result<HttpResponse, error::PayloadError>
/// {
...
///
/// ```rust
/// use loony::web::{self, App, FromRequest};
///
