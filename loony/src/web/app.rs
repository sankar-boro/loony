    ...
    Err: ErrorRenderer,
{
    ...
    ///
    /// loony provides several services implementations:
    ///
    ...
    ///
    /// ```rust
    /// use loony::web::{self, App, HttpRequest, HttpResponse, Error};
    ///
    ...
    ///
    /// ```rust
    /// use loony::http::header::{CONTENT_TYPE, HeaderValue};
