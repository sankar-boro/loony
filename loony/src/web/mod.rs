...
//!
//! * [User Guide](https://docs.rs/loony/)
//! * [GitHub repository](https://github.com/loony-rs/loony)
//! * [Cargo package](https://crates.io/crates/loony)
//!
//! To get started navigating the API documentation you may want to
//! consider looking at the following pages:
//!
//! * [App](struct.App.html): This struct represents an loony web
...
pub use loony_macros::web_connect as connect;
pub use loony_macros::web_delete as delete;
pub use loony_macros::web_get as get;
pub use loony_macros::web_head as head;
pub use loony_macros::web_options as options;
pub use loony_macros::web_patch as patch;
pub use loony_macros::web_post as post;
pub use loony_macros::web_put as put;
pub use loony_macros::web_trace as trace;
...
pub mod dev {
    //! The `loony::web` prelude for library developers
    //!
    //! The purpose of this module is to alleviate imports of many common
    //! traits by adding a glob import to the top of loony::web heavy modules:
