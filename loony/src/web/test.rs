//! Various helpers for loony applications to use during testing.
use std::{
...
///
/// ```rust
/// use loony::service::Service;
/// use loony::http::StatusCode;
/// use loony::web::{self, test, App, HttpResponse};
///
/// #[loony::test]
...
///
/// ```rust
/// use loony::{http::header, util::Bytes};
/// use loony::web::{self, test, App, HttpResponse};
///
/// #[loony::test]
/// async fn test_index() {
...
///
/// ```rust
/// use loony::{util::Bytes, http::header};
/// use loony::web::{self, test, App, HttpResponse};
///
/// #[loony::test]
/// async fn test_index() {
...
///
/// For unit testing, loony provides a request builder type and a simple handler runner. TestRequest implements a builder-like pattern.
/// You can generate various types of request via TestRequest's methods:
///  * `TestRequest::to_request` creates `loony::http::Request` instance.
...
///
/// ```rust
/// use loony::http::{header, StatusCode, HttpMessage};
/// use loony::web::{self, test, HttpRequest, HttpResponse};
///
...
/// integration tests cases for loony web applications.
///
/// # Examples
///
/// ```rust
    ...
    B: MessageBody + 'static,
{
    ...
    thread::spawn(move || {
        let mut sys = System::new("loony-test-server");
