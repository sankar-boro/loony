...
* Add `loony::time::now()` helper, returns low res time.

* Add `loony::time::system_time()` helper, returns low res system time.
...
* use loony-bytes instead of bytes
...
* Move various utils to loony-util crate
...
* Use `main` and `test` proc macro from loony-macros
...
* Introduce loony::framed module

* Upgrade to loony-codec 0.2

* Drop deprecated loony::util::order
...
* Drop deprecated loony::framed mod
...
* loony::util: Add `Buffer` service

* loony::framed: Deprecate

## [0.1.19] - 2020-06-12

* loony::framed: Deprecate `Connect` and `ConnectResult`

* loony::http: Move `Extensions` type to `loony::util`

## [0.1.18] - 2020-05-29

* loony::connect: Add `connect` helper function

* loony::connect: Add `Address` impl for `SocketAddr`

## [0.1.17] - 2020-05-18

* loony::util: Add Variant service

## [0.1.16] - 2020-05-10

* loony::http: Remove redundant BodySize::Sized64

* loony::http: Do not check h1 keep-alive during response processing

* loony::channel: Split pooled oneshot to separate module

## [0.1.15] - 2020-05-03

* loony::util: Refactor stream dispatcher

* loony::http: Drop camel case headers support

* loony::http: Fix upgrade service readiness check

* loony::http: Add client websockets helper

* loony::ws: Add stream and sink wrappers for ws protocol

* loony::web: Add websockets helper

## [0.1.14] - 2020-04-27

* loony::http: Stop client connections pool support future

* loony::http: Removed IntoHeaderValue trait, use TryFrom instead

* loony::ws: Fix wrong opcode for ws text and binary continuation frames

## [0.1.13] - 2020-04-21

* loony::http: Refactor client connection pool

## [0.1.12] - 2020-04-20

* loony::channel: Add mpsc close checks

* loony::channel: Add oneshot close checks

## [0.1.11] - 2020-04-15

* loony::web: Allow to add multiple routes at once

* loony::web: Add `App::with_config` method, simplifies app service factory.

* loony::web: Fix error type for Either responder

## [0.1.10] - 2020-04-13

* loony::channel: mpsc::Sender::close() must close receiver

## [0.1.9] - 2020-04-13

* loony::util: Refcator framed dispatcher

* loony::framed: Use framed dispatcher instead of custom one

* loony::channel: Fix mpsc::Sender close method.

## [0.1.8] - 2020-04-12

* loony::web: Fix definition of `ok_service` and `default_service`.

* loony::web: Add default error impl for `http::PayloadError`

* loony::web: Add default error impl for `http::client::SendRequestError`

* loony::web: Move `web::Data` to `web::types::Data`

* loony::web: Simplify Responder trait

* loony::web: Simplify WebResponse, remove `B` generic parameter

## [0.1.7] - 2020-04-10

* loony::http: Fix handling of large http messages

* loony::http: Refine read/write back-pressure for h1 dispatcher

* loony::web: Restore proc macros for handler registration

## [0.1.6] - 2020-04-09

* loony::web: Allow to add multiple services at once

* loony::http: Remove ResponseBuilder::json2 method

## [0.1.5] - 2020-04-07

* loony::http: enable client disconnect timeout by default

* loony::http: properly close h1 connection

* loony::framed: add connection disconnect timeout to framed service
