...
/// ```rust
/// use std::io;
/// use loony_service::{fn_factory, fn_service, Service, ServiceFactory};
///
...
/// ```rust
/// use std::io;
/// use loony_service::{fn_factory_with_config, fn_service, Service, ServiceFactory};
///
/// #[loony::main]
/// async fn main() -> io::Result<()> {
